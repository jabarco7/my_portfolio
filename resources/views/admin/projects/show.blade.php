                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <form action="{{ route('admin.projects.toggle-active', $project) }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="btn {{ $project->is_active ? 'btn-secondary' : 'btn-success' }} btn-block">
                            ...
                            <form action="{{ route('admin.projects.toggle-featured', $project) }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="btn {{ $project->is_featured ? 'btn-secondary' : 'btn-warning' }} btn-block">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="card h-100">
                                            <img src="{{ asset('storage/' . $image->image_path) }}"
                                                alt="{{ $image->caption ?? $project->title }}" class="card-img-top"
