                        ...
                        <div class="mb-6 bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-4 sm:p-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                                    <div>
                                        <label for="stats_technologies_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Technologies Count</label>
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" id="stats_technologies_count" name="stats[technologies_count]" value="{{ $statsContent->technologies_count ?? '25+' }}" placeholder="e.g., 25+">
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Number of technologies you work with</p>
                                    </div>
                                    <div>
                                        <label for="stats_expert_level" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Expert Level</label>
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" id="stats_expert_level" name="stats[expert_level]" value="{{ $statsContent->expert_level ?? '8/10' }}" placeholder="e.g., 8/10">
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Your expertise level rating</p>
                                    </div>
                                    <div>
                                        <label for="stats_up_to_date_percentage" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Up to Date Percentage</label>
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" id="stats_up_to_date_percentage" name="stats[up_to_date_percentage]" value="{{ $statsContent->up_to_date_percentage ?? '100%' }}" placeholder="e.g., 100%">
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">How up-to-date your skills are</p>
                                    </div>
                                </div>
                            </div>
                        </div>
