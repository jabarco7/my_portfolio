...
@section('content')
    ...
    <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold mb-2">Edit Skill</h1>
                <p class="text-purple-100 opacity-90">Update skill information</p>
            </div>
...
<div>
    ...
    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="percentage" id="percentage" value="{{ old('percentage', $skill->percentage) }}" min="0" max="100"
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $skill->is_active) ? 'checked' : '' }}
