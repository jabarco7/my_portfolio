...
@section('title', 'Create Certificate Category')
...
@section('content')
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-blue-100 opacity-90">Add a new certificate category</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        <form action="{{ route('admin.certificate-categories.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="text" name="color" id="color" value="{{ old('color', '#6B7280') }}"
                            ...
                            placeholder="#6B7280">
                        <input type="color" id="color-picker" value="{{ old('color', '#6B7280') }}"
