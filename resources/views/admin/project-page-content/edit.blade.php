...
@section('title', 'Edit Project Page Content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h6 class="mb-0">Edit Project Page Content</h6>
                            <p class="text-sm mb-0">
                                Update dynamic content for the projects page.
                            </p>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.project-page-content.update', $projectPageContent->id) }}" method="POST" id="contentForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('section_type') is-invalid @enderror" 
                                        ...
                                        @foreach($sectionTypes as $key => $label)
                                            <option value="{{ $key }}" {{ old('section_type', $projectPageContent->section_type) == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('order') is-invalid @enderror" 
                                           ...
                                           value="{{ old('order', $projectPageContent->order) }}" min="0">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                   value="1" {{ old('is_active', $projectPageContent->is_active) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load fields for current section type
...
function loadDynamicFields(sectionType) {
    ...
    const existingData = @json($projectPageContent->content_data ?? []);
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="content_data[projects_count]" 
                                   value="${existingData.projects_count || ''}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[completed_projects]" 
                                   value="${existingData.completed_projects || ''}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[client_satisfaction]" 
                                   value="${existingData.client_satisfaction || ''}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][key]" 
                                                   value="${filter.key || ''}" placeholder="e.g., all, laravel, vue" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][label]" 
                                                   value="${filter.label || ''}" placeholder="e.g., All Projects, Laravel" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][title]" 
                                                   value="${type.title || ''}" placeholder="e.g., Web Applications" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][count]" 
                                                   value="${type.count || ''}" placeholder="e.g., 15+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="content_data[${index}][description]" 
                                                      rows="3" placeholder="Brief description" required>${type.description || ''}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][icon]" 
                                                   value="${type.icon || ''}" placeholder="e.g., fas fa-window-restore">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="content_data[${index}][color]" 
                                                   value="${type.color || 'from-primary-500 to-secondary-500'}" 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="content_data[${index}][step]" 
                                                   value="${step.step || String(index + 1).padStart(2, '0')}" min="01" max="99" required>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="form-control-label">Title *</label>
                                            <input type="text" class="form-control" name="content_data[${index}][title]" 
                                                   value="${step.title || ''}" placeholder="e.g., Discovery & Planning" required>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="form-control-label">Icon Class</label>
                                            <input type="text" class="form-control" name="content_data[${index}][icon]" 
                                                   value="${step.icon || ''}" placeholder="e.g., fas fa-lightbulb">
                                            <small class="form-text text-muted">FontAwesome icon class</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label class="form-control-label">Description *</label>
                                            <textarea class="form-control" name="content_data[${index}][description]" 
                                                      rows="3" placeholder="Step description" required>${step.description || ''}</textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[title]" 
                                   value="${existingData.title || 'Ready to Start Your Next Project?'}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content_data[description]" 
                                      rows="3" required>${existingData.description || 'Let\'s collaborate to create something amazing that meets your goals and exceeds expectations.'}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[primary_button_text]" 
                                   value="${existingData.primary_button_text || 'Start a Project'}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[primary_button_link]" 
                                   value="${existingData.primary_button_link || '/contact'}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[secondary_button_text]" 
                                   value="${existingData.secondary_button_text || 'View My Skills'}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_data[secondary_button_link]" 
                                   value="${existingData.secondary_button_link || '/skills'}">
                        </div>
                    </div>
                </div>
            `;
