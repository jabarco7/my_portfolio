...
@section('content')
    ...
    <section id="project-detail-hero" class="relative min-h-[70vh] lg:min-h-screen flex items-center overflow-hidden bg-base-100 pt-12 lg:pt-16">
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <div class="animate-slide-up">
                        ...
                        <div
                            ...
                            {{ $heroContent['badge_text'] ?? 'Project Case Study' }}
                        </div>
                        ...
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                            ...
                            <span
                                ...
                                {{ $heroContent['title'] ?? 'Project Details' }}
                            </span>
                        </h1>
    ...
    <section id="project-content" class="py-12 lg:py-16 bg-base-100/50 relative">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div class="lg:col-span-2 space-y-8 lg:space-y-12">
                        ...
                        @if ($project->images && $project->images->count() > 0)
                            <div class="bg-base-100 rounded-2xl border border-base-300 shadow-lg p-8">
                                <div class="flex items-center gap-3 mb-8">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-xl">
                                        <i class="fas fa-images"></i>
                                    </div>
                                    <div>
                                        <h2 class="text-2xl font-bold text-base-content">{{ $galleryContent['title'] ?? 'Project Gallery' }}</h2>
                                        <p class="text-base-content/70">{{ $galleryContent['subtitle'] ?? 'Visual showcase of the project' }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-base-100 rounded-2xl border border-base-300 shadow-lg p-8">
                            <div class="flex items-center gap-3 mb-8">
                                <div
                                    class="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center text-white text-xl">
                                    <i class="fas fa-star"></i>
                                </div>
                                <div>
                                    <h2 class="text-2xl font-bold text-base-content">{{ $featuresContent['title'] ?? 'Key Features' }}</h2>
                                    <p class="text-base-content/70">{{ $featuresContent['subtitle'] ?? 'Notable functionalities and capabilities' }}</p>
                                </div>
                            </div>
            ...
            'Security Focused' => 'Built with security best practices in mind',
                                    ...
                                    <div
                                        class="flex gap-4 p-4 rounded-lg bg-base-200/50 hover:bg-base-200 transition-colors duration-300">
                                        <div
                    ...
                    <div class="lg:col-span-1 space-y-6 lg:space-y-8">
                        ...
                        <div class="bg-base-100 rounded-2xl border border-base-300 shadow-lg p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center text-white">
                                    <i class="fas fa-cog"></i>
                                </div>
                                <h3 class="text-xl font-bold text-base-content">{{ $projectDetailsContent['title'] ?? 'Project Details' }}</h3>
                            </div>
                                ...
                                @if ($project->technologies)
                                    <div>
                                        <div class="flex items-center gap-2 mb-3">
                                            ...
                                            <span class="font-medium text-base-content">{{ $projectDetailsContent['technologies_title'] ?? 'Technologies Used' }}</span>
                                        </div>
                        ...
                        <!-- Back to Portfolio -->
                        <div
                            class="bg-gradient-to-br from-primary-500/10 via-transparent to-secondary-500/10 rounded-2xl border border-primary/20 p-8">
                            <div class="text-center">
                                <div
                                    class="w-16 h-16 rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center text-white text-2xl mb-4 mx-auto">
                                    <i class="fas fa-arrow-left"></i>
                                </div>
                                <h4 class="text-lg font-bold text-base-content mb-2">{{ $exploreMoreContent['title'] ?? 'Explore More Projects' }}</h4>
                                <p class="text-base-content/70 mb-6">{{ $exploreMoreContent['subtitle'] ?? 'Check out other projects in my portfolio' }}</p>
                        ...
                        <div class="bg-base-100 rounded-2xl border border-base-300 shadow-lg p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white">
                                    <i class="fas fa-share-alt"></i>
                                </div>
                                <h3 class="text-xl font-bold text-base-content">{{ $shareContent['title'] ?? 'Share Project' }}</h3>
                            </div>
    ...
    <section id="challenges" class="py-12 lg:py-16 bg-base-200/30 relative">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Solutions</span>
                    </h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-xl mb-6">
                            <i class="fas fa-exclamation-triangle"></i>
                        </div>
                        <h3 class="text-xl font-bold text-base-content mb-4">{{ $challengesContent['challenges_title'] ?? 'Key Challenges' }}</h3>
                        <ul class="space-y-3">
                            @if(isset($challenges) && count($challenges) > 0)
                                @foreach ($challenges as $challenge)
                            <li class="flex items-start gap-3">
                                <i class="fas fa-times text-red-500 mt-1"></i>
                                <span class="text-base-content/70">{{ $challenge }}</span>
                            </li>
                            @endforeach
                            @else
                            <li class="text-base-content/70">No challenges specified.</li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-xl mb-6">
                            <i class="fas fa-check-circle"></i>
                        </div>
                        <h3 class="text-xl font-bold text-base-content mb-4">{{ $challengesContent['solutions_title'] ?? 'Implemented Solutions' }}</h3>
                        <ul class="space-y-3">
                            @if(isset($solutions) && count($solutions) > 0)
                                @foreach ($solutions as $solution)
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check text-green-500 mt-1"></i>
                                <span class="text-base-content/70">{{ $solution }}</span>
                            </li>
                            @endforeach
                            @else
                            <li class="text-base-content/70">No solutions specified.</li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xl mb-6">
                            <i class="fas fa-chart-line"></i>
                        </div>
                        <h3 class="text-xl font-bold text-base-content mb-4">Key Results</h3>
                        <ul class="space-y-3">
                            @if(isset($results))
                                @foreach ($results as $result)
                            <li class="flex items-start gap-3">
                                <i class="fas fa-chart-line text-blue-500 mt-1"></i>
                                <span class="text-base-content/70">{{ $result }}</span>
                            </li>
                            @endforeach
                            @else
                            <li class="text-base-content/70">No results specified.</li>
                            @endif
                        </ul>
                    </div>
                </div>
    ...
    <!-- CTA Section -->
    <section id="project-detail-cta" class="py-12 lg:py-16 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Let's
                        Work Together</span>
                </h2>
