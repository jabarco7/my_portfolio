                    ...
                    <div class="animate-slide-up">
                        ...
                        <div class="space-y-4 mb-8">
                            <p class="text-lg text-base-content/70 leading-relaxed">
                                Explore my portfolio of web development projects. Each project represents a unique challenge solved with clean code, modern design, and user-focused solutions.
                            </p>
                            <p class="text-lg text-base-content/70 leading-relaxed">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10">
                            <div class="text-center p-4 rounded-xl bg-base-200/50 backdrop-blur-sm border border-base-300">
                                <div class="text-3xl font-bold text-primary mb-2">{{ $projects->count() }}+</div>
                                <div class="text-sm text-base-content/70">Projects</div>
                            </div>
                            <div class="text-center p-4 rounded-xl bg-base-200/50 backdrop-blur-sm border border-base-300">
                                <div class="text-3xl font-bold text-secondary mb-2">{{ $totalActiveProjects ?? '50+' }}</div>
                                ...
                                <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-base-300">
                                    ...
                                    <div class="p-6 bg-base-100">
                                        ...
                                        <div class="flex flex-wrap gap-2 mb-4">
                                            <span class="px-2 py-1 rounded bg-base-200 text-xs text-base-content">Laravel</span>
                                            <span class="px-2 py-1 rounded bg-base-200 text-xs text-base-content">Vue.js</span>
                                            <span class="px-2 py-1 rounded bg-base-200 text-xs text-base-content">Tailwind</span>
                                        </div>
                                        <div class="flex gap-3">
                                            <button class="flex-1 py-2 rounded-lg bg-primary/10 text-primary text-sm font-medium hover:bg-primary/20 transition-colors duration-300">
                                                Live Demo
                                            </button>
                                            <button class="flex-1 py-2 rounded-lg bg-base-200 text-base-content text-sm font-medium hover:bg-base-300 transition-colors duration-300">
                                                View Details
                                            </button>
                                        </div>
                                    </div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        ...
                        <p class="text-base-content/70">Filter by technology or project type</p>
                    </div>
                    
                    <!-- Filter Buttons -->
                    <div class="flex flex-wrap gap-3">
                        <button data-filter="all" class="project-filter-btn active px-4 py-2 rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-medium transition-all duration-300 hover:shadow-lg">
                            All Projects
                        </button>
                        <button data-filter="laravel" class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                            Laravel
                        </button>
                        <button data-filter="vue" class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                            Vue.js
                        </button>
                        <button data-filter="react" class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                            React
                        </button>
                        <button data-filter="fullstack" class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                            Full Stack
                        </button>
                    </div>
                </div>
                ...
                @if ($projects->count() > 0)
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        @foreach ($projects as $project)
                            @php
                                // Determine project category based on description or other logic
                                $categories = ['laravel', 'vue', 'react', 'fullstack'];
                                $category = $categories[array_rand($categories)];
                                
                                // Tech stack for badges
                                $techStack = ['Laravel', 'Vue.js', 'Tailwind', 'MySQL', 'API', 'Responsive'];
                                shuffle($techStack);
                                $projectTech = array_slice($techStack, 0, 3);
                            @endphp
                                ...
                                <div class="bg-base-100 rounded-2xl border border-base-300 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden h-full flex flex-col">
                                    ...
                                    <div class="relative h-64 overflow-hidden">
                                        ...
                                        <div class="absolute top-4 right-4">
                                            <span class="px-3 py-1 rounded-full bg-primary/90 backdrop-blur-sm text-white text-xs font-medium">
                                                {{ ucfirst($category) }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-6 flex-grow">
                                        <div class="flex items-start justify-between mb-4">
                                            ...
                                            @if($project->is_featured)
                                                <span class="px-2 py-1 rounded bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-400 text-xs font-medium">
                                                    Featured
                                                </span>
                                            @endif
                                        </div>
                                        ...
                                        <!-- Project Meta -->
                                        <div class="flex items-center justify-between text-sm text-base-content/60 border-t border-base-300 pt-4">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">I Build</span>
                    </h2>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group">
                        <div class="bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full">
                            <div class="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br {{ $type['color'] }} text-white text-2xl mb-6">
                                <i class="{{ $type['icon'] }}"></i>
                            </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Ideas to Life</span>
                    </h2>
                    <p class="text-lg text-base-content/70 max-w-3xl mx-auto">
                        Every successful project follows a structured process to ensure quality, efficiency, and client satisfaction.
                    </p>
                </div>
                ...
                <div class="relative">
                    <!-- Timeline Line -->
                    <div class="absolute left-8 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-gradient-to-b from-primary-400 to-secondary-400 hidden md:block"></div>
                    ...
                    <div class="space-y-12 md:space-y-0">
                        ...
                        <div class="relative md:w-1/2 {{ $loop->iteration % 2 == 0 ? 'md:ml-auto md:pl-12' : 'md:pr-12' }}">
                            <!-- Step Circle -->
                            <div class="absolute left-0 md:left-auto {{ $loop->iteration % 2 == 0 ? 'md:-left-6' : 'md:-right-6' }} top-6 w-12 h-12 rounded-full border-4 border-base-100 bg-gradient-to-r from-primary-500 to-secondary-500 flex items-center justify-center text-white font-bold z-10">
                                {{ $step['step'] }}
                            </div>
                            
                            <!-- Step Card -->
                            <div class="ml-14 md:ml-0 bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                <div class="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-primary/10 text-primary text-xl mb-4">
                                    <i class="{{ $step['icon'] }}"></i>
                                </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Next Project?</span>
                </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('skills') }}" class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-base-200 backdrop-blur-sm border border-base-300 text-base-content font-semibold rounded-xl hover:bg-base-300 shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative bg-base-100 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div class="sticky top-0 z-10 flex justify-between items-center p-6 border-b border-base-300 bg-base-100">
                    ...
                    <button onclick="hideProjectModal()" class="w-10 h-10 rounded-lg bg-base-200 hover:bg-base-300 flex items-center justify-center transition-colors duration-300">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold text-base-content">6 weeks</span>
                                </div>
                            </div>
                        </div>
                    </div>
