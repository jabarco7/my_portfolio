            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @if ($pageContent['filter_buttons'] ?? null)
                            @foreach ($pageContent['filter_buttons'] as $index => $button)
                                <button data-filter="{{ $button['key'] }}"
                                    class="project-filter-btn {{ $index === 0 ? 'active' : '' }} px-4 py-2 rounded-lg {{ $index === 0 ? 'bg-gradient-to-r from-primary-500 to-secondary-500 text-white' : 'bg-base-200 text-base-content border border-base-300 hover:bg-base-300' }} font-medium transition-all duration-300 hover:shadow-lg">
                                    {{ $button['label'] }}
                                </button>
                            @endforeach
                        @else
                            <button data-filter="all"
                                class="project-filter-btn active px-4 py-2 rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-medium transition-all duration-300 hover:shadow-lg">
                                All Projects
                            </button>
                            <button data-filter="web-development"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                Web Development
                            </button>
                            <button data-filter="mobile-app-development"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                Mobile App Development
                            </button>
                            <button data-filter="e-commerce-solutions"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                E-commerce Solutions
                            </button>
                            <button data-filter="api-development"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                API Development
                            </button>
                            ...
                            <button data-filter="database-design"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                Database Design
                            </button>
                            <button data-filter="devops-deployment"
                                class="project-filter-btn px-4 py-2 rounded-lg bg-base-200 text-base-content font-medium border border-base-300 hover:bg-base-300 transition-all duration-300">
                                DevOps & Deployment
                            </button>
                        @endif
