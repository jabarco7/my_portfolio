...
@section('content')
                    ...
                    <div class="animate-slide-up">
                        ...
                        <div class="space-y-4 mb-8">
                            <p class="text-lg text-base-content/70 leading-relaxed">
                                Over the years, I've cultivated a diverse skill set that spans both frontend and backend development. I believe in using the right tool for the job and continuously expanding my knowledge.
                            </p>
                            <p class="text-lg text-base-content/70 leading-relaxed">
                                Here's a comprehensive overview of my technical capabilities, from programming languages and frameworks to tools and methodologies.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <a href="{{ route('contact') }}" class="group inline-flex items-center gap-3 px-8 py-4 bg-base-200 backdrop-blur-sm border border-base-300 text-base-content font-semibold rounded-xl hover:bg-base-300 shadow-md hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="relative hidden lg:block">
                        <div class="relative max-w-lg mx-auto">
                            ...
                            <div class="relative bg-gradient-to-br from-primary-400/20 via-transparent to-secondary-400/20 rounded-3xl p-8 backdrop-blur-sm">
                                <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-base-300 bg-gradient-to-br from-gray-900 to-gray-800">
                                    <!-- Interactive Skills Grid -->
                                    <div class="p-8">
                                        <div class="grid grid-cols-3 gap-4 mb-8">
                                            @foreach(['Laravel', 'Vue', 'React', 'Node', 'Tailwind', 'Docker'] as $skill)
                                            <div class="relative group">
                                                <div class="aspect-square rounded-xl bg-gradient-to-br from-primary-500/20 to-secondary-500/20 flex items-center justify-center border border-primary/30 group-hover:scale-110 transition-transform duration-300">
                                                    <div class="text-center">
                                                        <div class="text-2xl font-bold text-primary mb-1">{{ substr($skill, 0, 1) }}</div>
                                                        <div class="text-xs text-gray-300">{{ $skill }}</div>
                                                    </div>
                                                </div>
                                                <div class="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-green-400 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                            </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                ...
                                                <div class="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                                    <div class="h-full bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full animate-progress" style="width: 95%"></div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="flex justify-between text-sm text-gray-300 mb-1">
                                                ...
                                                <div class="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                                    <div class="h-full bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full animate-progress" style="width: 90%"></div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="flex justify-between text-sm text-gray-300 mb-1">
                                                ...
                                                <div class="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                                    <div class="h-full bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full animate-progress" style="width: 85%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Matrix</span>
                    </h2>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Methodologies</span>
                    </h2>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    @foreach([
                        ['title' => 'Agile/Scrum', 'icon' => 'fas fa-sync-alt', 'color' => 'bg-blue-500/10 text-blue-500 border-blue-500/20'],
                        ['title' => 'Test-Driven Dev', 'icon' => 'fas fa-vial', 'color' => 'bg-green-500/10 text-green-500 border-green-500/20'],
                        ['title' => 'CI/CD', 'icon' => 'fas fa-code-branch', 'color' => 'bg-purple-500/10 text-purple-500 border-purple-500/20'],
                        ['title' => 'Mobile First', 'icon' => 'fas fa-mobile-alt', 'color' => 'bg-orange-500/10 text-orange-500 border-orange-500/20'],
                        ['title' => 'Responsive Design', 'icon' => 'fas fa-desktop', 'color' => 'bg-cyan-500/10 text-cyan-500 border-cyan-500/20'],
                        ['title' => 'API First', 'icon' => 'fas fa-network-wired', 'color' => 'bg-indigo-500/10 text-indigo-500 border-indigo-500/20'],
                        ['title' => 'Version Control', 'icon' => 'fab fa-git-alt', 'color' => 'bg-red-500/10 text-red-500 border-red-500/20'],
                        ['title' => 'Cloud Native', 'icon' => 'fas fa-cloud', 'color' => 'bg-teal-500/10 text-teal-500 border-teal-500/20'],
                    ] as $method)
                    <div class="group">
                        <div class="bg-base-100 rounded-xl p-6 border {{ $method['color'] }} text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full {{ $method['color'] }} text-2xl mb-4">
    ...
    <section id="skills-evolution" class="py-20 bg-base-100 relative">
        <div class="absolute inset-0 overflow-hidden opacity-10">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        <span class="text-base-content">My Learning</span>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Journey</span>
                    </h2>
                    <p class="text-lg text-base-content/70 max-w-3xl mx-auto">
                        Technology evolves rapidly, and so does my skill set. Here's a glimpse of my continuous learning journey.
                    </p>
                </div>

                <!-- Timeline -->
                <div class="relative">
                    <div class="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-primary-400 to-secondary-400 hidden lg:block"></div>
                    
                    <div class="space-y-12">
                        @foreach([
                            ['year' => '2023', 'skills' => ['Advanced React Patterns', 'Next.js 13', 'Microservices', 'AWS Advanced'], 'color' => 'from-green-500 to-emerald-500'],
                            ['year' => '2022', 'skills' => ['TypeScript Mastery', 'GraphQL', 'Docker', 'CI/CD Pipelines'], 'color' => 'from-blue-500 to-cyan-500'],
                            ['year' => '2021', 'skills' => ['Vue 3 Composition API', 'Laravel 8', 'Tailwind CSS', 'Testing'], 'color' => 'from-purple-500 to-pink-500'],
                            ['year' => '2020', 'skills' => ['React Hooks', 'Node.js', 'REST APIs', 'Git Advanced'], 'color' => 'from-orange-500 to-red-500'],
                        ] as $timeline)
                        <div class="relative lg:w-1/2 {{ $loop->iteration % 2 == 0 ? 'lg:pl-12 lg:ml-auto lg:mr-0' : 'lg:pr-12 lg:ml-0 lg:mr-auto' }}">
                            <!-- Timeline dot -->
                            <div class="absolute top-6 left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full border-4 border-base-100 bg-gradient-to-r {{ $timeline['color'] }} z-10 hidden lg:block"
                                 style="{{ $loop->iteration % 2 == 0 ? 'right: calc(100% - 12px)' : 'left: calc(100% - 12px)' }}">
                            </div>
                            
                            <!-- Content card -->
                            <div class="bg-base-100 rounded-2xl p-8 border border-base-300 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                ...
                                <h3 class="text-xl font-bold mb-4 text-base-content">New Skills Acquired</h3>
                                <div class="flex flex-wrap gap-2">
                                    @foreach($timeline['skills'] as $skill)
                                    <span class="px-3 py-1.5 rounded-lg bg-base-200 text-base-content text-sm font-medium border border-base-300">
                                        {{ $skill }}
                                    </span>
                                    @endforeach
                                </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Skill Set?</span>
                </h2>
                <p class="text-xl text-base-content/70 mb-10 max-w-2xl mx-auto">
                    Whether you need expertise in a specific technology or a combination of skills, I'm ready to tackle your project challenges.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('about') }}" class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-base-200 backdrop-blur-sm border border-base-300 text-base-content font-semibold rounded-xl hover:bg-base-300 shadow-md hover:shadow-lg transition-all duration-300">
