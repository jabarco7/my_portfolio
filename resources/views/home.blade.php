                    ...
                    <div class="animate-slide-up">
                        ...
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-base-content/70 mb-6">
                            ...
                            <span class="relative inline-block">
                                <span class="text-base-content">Web Developer</span>
                                <span
                                    class="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-primary-400 to-transparent rounded-full"></span>
                            </span>
                        </h2>

                        <!-- Description -->
                        <p class="text-lg md:text-xl text-base-content/60 mb-8 leading-relaxed">
                            I craft digital experiences that are fast, accessible, visually appealing, and responsive.
                        ...
                        <div class="mb-12">
                            ...
                            <div class="flex flex-wrap gap-3">
                                @foreach (['Laravel', 'Vue.js', 'Tailwind', 'React', 'Node.js', 'MySQL', 'Git', 'Docker'] as $tech)
                                    <span
